import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderScript, b as renderComponent } from '../chunks/astro/server_B02qANs2.mjs';
import 'kleur/colors';
...
Número telefónico
</label> <input class="p-4 border border-gray-400 outline-orange-200 rounded-lg w-full" type="tel" id="telephone" name="telephone" placeholder="Ingrese un número telefónico" required pattern="[0-9]{9,15}" title="Debe contener entre 9 y 15 dígitos numéricos"> </div> <div> <label for="subject" class="text-gray-500 mb-2 block">
Asunto
