...
const $$EncantoAmazonico = createComponent(($$result, $$props, $$slots) => {
  const tour = {
    image: "/../tours/toursdiariosencantoamazonico.avif",
...
Recojo de su hotel y traslado al puerto de Bellavista Nanay (tour gastronómico exprés:
<br> <strong>
tacacho, suri, pescados y caimán a la parrilla).
</strong> </li> <li class="indent-[-1.5em] pl-[1.5em]">
Viaje por el río Nanay
<strong>
(importante río de aguas oscuras)
</strong>.
</li> <li class="indent-[-1.5em] pl-[1.5em]">
Navegación por el río Momón
<strong>
(río mediano de aguas marrones)
</strong>.
</li> <li class="indent-[-1.5em] pl-[1.5em]">
Trapiche del Momón
<strong>
(centro de tragos afrodisíacos y medicina tradicional)
</strong>.
</li> <li class="indent-[-1.5em] pl-[1.5em]">
Serpentario Javier
<strong>
(santuario de animales: observación de oso perezoso, anaconda, etc.)
</strong>.
</li> <li class="indent-[-1.5em] pl-[1.5em]">
Acuario de peces ornamentales, experiencia exótica con anguila eléctrica.
</li> <li class="indent-[-1.5em] pl-[1.5em]">
Comunidad nativa Bora
<strong>
(danzas típicas, artesanía)
</strong>.
</li> <li class="indent-[-1.5em] pl-[1.5em]">
Mirador Amazolandia
<strong>
...
}, "C:/astro/iquitos-expedition/src/components/ToursDiarios/EncantoAmazonico.astro", void 0);

const $$ElEncantoAmazonico = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Navbar", $$Navbar, {})} ${renderComponent($$result2, "BreadcrumbIrapay", $$BreadcrumbIrapay, {})} ${renderComponent($$result2, "EncantoAmazonicoPC", $$EncantoAmazonico, {})} ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
}, "C:/astro/iquitos-expedition/src/pages/paquetes/tours-diarios/el-encanto-amazonico.astro", void 0);

const $$file = "C:/astro/iquitos-expedition/src/pages/paquetes/tours-diarios/el-encanto-amazonico.astro";
const $$url = "/paquetes/tours-diarios/el-encanto-amazonico";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    default: $$ElEncantoAmazonico,
    file: $$file,
    url: $$url
