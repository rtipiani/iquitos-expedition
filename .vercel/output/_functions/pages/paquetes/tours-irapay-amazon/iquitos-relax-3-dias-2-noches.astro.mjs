...
const $$3Dias = createComponent(($$result, $$props, $$slots) => {
  const tour = {
...
}, "C:/astro/iquitos-expedition/src/components/IrapayAmazon/3Dias.astro", void 0);

const $$IquitosRelax3Dias2Noches = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Navbar", $$Navbar, {})} ${renderComponent($$result2, "BreadcrumbIrapay", $$BreadcrumbIrapay, {})} ${renderComponent($$result2, "IrapayAmazon3Dias", $$3Dias, {})} ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
