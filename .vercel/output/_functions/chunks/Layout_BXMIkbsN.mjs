import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderScript, e as renderSlot, f as renderHead, a as addAttribute } from './astro/server_CEj8L07F.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                         */

const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header id="main-header" class="fixed top-0 left-0 w-full backdrop-blur-md z-50"> <nav class="container mx-auto flex items-center justify-between px-6 py-4"> <div> <a href="/"> <img src="/logoDark.avif" width="180" height="60" alt="Logo Iquitos Expedition"> </a> </div> <button id="menu-toggle" class="xl:hidden text-white focus:outline-none" aria-label="Abrir Menú"> <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 transition-transform duration-300 ease-in-out" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path> </svg> </button> <ul id="menu" class="hidden xl:flex flex-col xl:flex-row items-center text-white absolute xl:relative top-full left-0 w-full xl:w-auto bg-black bg-opacity-80 xl:bg-transparent shadow-md xl:shadow-none transition-all duration-300 ease-in-out text-center"> <li> <a href="/" class="block py-3 px-6 hover:text-yellow-400 transition menu-link">
Inicio
</a> </li> <li> <a href="/about" class="block py-3 px-6 hover:text-yellow-400 transition menu-link">
Nosotros
</a> </li> <li class="hidden xl:block"> <a href="/paquetes/irapay-amazon" class="block py-3 px-6 hover:text-yellow-400 transition menu-link">
Irapay Amazon
</a> </li> <li class="hidden xl:block"> <a href="/paquetes/heliconia-lodge" class="block py-3 px-6 hover:text-yellow-400 transition menu-link">
Heliconia Lodge
</a> </li> <li class="hidden xl:block"> <a href="/paquetes/cumaceba-lodge" class="block py-3 px-6 hover:text-yellow-400 transition menu-link">
Cumaceba Lodge
</a> </li> <li class="hidden xl:block"> <a href="/paquetes/pacaya-samiria" class="block py-3 px-6 hover:text-yellow-400 transition menu-link">
Pacaya Samiria
</a> </li> <li class="hidden xl:block"> <a href="/paquetes/tours-diarios" class="block py-3 px-6 hover:text-yellow-400 transition menu-link">
Tours Diarios
...
Tours Diarios
</a> </li> </ul> </li> <li> <a href="/gallery" class="block py-3 px-6 hover:text-yellow-400 transition menu-link">
Galería
</a> </li> <li> <a href="/contacts" class="block py-3 px-6 hover:text-yellow-400 transition menu-link">
Contacto
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  const meta = {
    title: "iquitosexpedition.com - Iquitos Expedition | Tours full day, paquetes ciudad, hotel y tours, Amazon Lodge todo incluido, paquetes exclusivos, pesca de pira\xF1as, comunidades nativas, isla de los monos, perezosos, Amazon Bio Park, Crea, Quisticocha, Lodge, Irapay Amazon Lodge, anacondas y mucho m\xE1s.",
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><meta name="robots" content="index, follow"><meta name="author" content="Rub\xE9n Tipiani"><meta name="copyright" content="Copyright (c) 2025, Iquitos Expedition"><title>\n			', '\n		</title><meta name="description"', '><meta property="og:site_name" content="Iquitos Expedition"><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image"', '><meta property="og:url"', '><meta property="og:type" content="website"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:type" content="image/webp"><meta property="twitter:card" content="summary_large_image"><meta property="twitter:title"', '><meta property="twitter:description"', '><meta property="twitter:image"', '><meta property="twitter:site" content="@iquitosexpedition"><link rel="canonical"', '><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png"><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png"><link rel="manifest" href="/site.webmanifest"><script src="https://www.google.com/recaptcha/api.js" async defer><\/script>', '</head> <body> <div id="loader" class="fixed inset-0 flex items-center justify-center bg-white z-50"> <div class="w-12 h-12 border-4 border-t-orange-600 border-gray-300 rounded-full animate-spin"></div> </div> ', ' <a href="https://wa.link/no5uic" target="_blank" rel="noopener noreferrer" class="fixed bottom-6 right-6 z-30 w-16 h-16 bg-green-500 text-white rounded-full flex items-center justify-center shadow-xl hover:bg-green-600 transition duration-300 transform hover:scale-110" aria-label="Ir a Whatsapp"> <i class="fa-brands fa-whatsapp text-2xl"></i> </a> ', " </body></html>"])), meta.title, addAttribute(meta.description, "content"), addAttribute(meta.title, "content"), addAttribute(meta.description, "content"), addAttribute(meta.image, "content"), addAttribute(meta.url, "content"), addAttribute(meta.title, "content"), addAttribute(meta.description, "content"), addAttribute(meta.image, "content"), addAttribute(meta.url, "href"), renderHead(), renderSlot($$result, $$slots["default"]), renderScript($$result, "C:/astro/iquitos-expedition/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts"));
